    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div
            ...
            <div class="px-8 pt-8 pb-5 text-center">
                <h2 class="text-blue-500 text-2xl font-bold mb-1 max-[480px]:text-xl">Registrasi Petugas</h2>
            ...
            <form action="{{ route('auth.register.process') }}" method="POST" class="px-8 pb-8 space-y-6">
                @csrf

                <div>
                    <label class="block mb-2 text-gray-700 font-semibold text-sm">Username</label>
                    <div class="relative">
                ...
                {{ $errors->has('username') ? 'border-red-500 focus:border-red-500 focus:ring-red-100' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-100' }}" />
                    </div>
